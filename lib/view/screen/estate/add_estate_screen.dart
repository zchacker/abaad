...
class _AddEstateScreenState extends State<AddEstateScreen> {
  ...
  final TextEditingController _advertiserNumberController = TextEditingController();
  final TextEditingController _advertiserTypeController = TextEditingController();
                                ...
                                Expanded(
                                  child:  !restController.isLoading ?  CustomButton(
                                    onPressed: () {
                                      ...
                                      adNumber= _addNumberController.text.trim();
                                      ...
                                      if(currentStep==1) {
                                        ...
                                        if(_djectivePresenter==0&&authorized.isEmpty){
