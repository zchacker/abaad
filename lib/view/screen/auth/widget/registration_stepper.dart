  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: Column(children: [
        ...
        Row(children: [
          Expanded(child: haveLeftBar ? Divider(color: color, thickness: 2) : SizedBox()),
          Icon( onGoing ? Icons.adjust : processing ? Icons.adjust : rightActive ? Icons.check_circle : Icons.circle_outlined, color: color, size: 30),
          Expanded(child: haveRightBar ? Divider(color: right, thickness: 2) : SizedBox()),
          ]),
