      ...
      body: SingleChildScrollView(
        ...
        child: Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: GetBuilder<AuthController>(builder: (authController) {
          ...
          return   GetBuilder<EstateController>(builder: (estateController) {
              ...
              buttonText: 'التالي',
              onPressed: () async {
              String numberLicense = _numberLicenseController.text.trim();
              ...
              bool isSuccess = await estateController.verifyLicense(numberLicense,advertiserNumber,advertiserType);
              ...
              if (isSuccess) {
               ...
               await prefs.setString('numberLicense', numberLicense);
               await prefs.setString('advertiserNumber', advertiserNumber);
