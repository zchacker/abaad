                                    ...
                                    child:Row(
                                      children: [
                                        ...
                                        if (widget.estate.categoryName == "ارض") ...[
                                          ...
                                          if (widget.estate.totalPrice != "undefined")
                                            Text(
                                              "إجمالي السعر",
                                              style: robotoRegular.copyWith(
                                                fontSize: Dimensions.fontSizeDefault,
...
//                                   : SizedBox(),
                          ...
                          widget.estate.networkType.isNotEmpty?    NetworkTypeItem(estate: widget.estate,restaurants: widget.estate.networkType):Container(),
