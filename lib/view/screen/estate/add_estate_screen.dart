...
class _AddEstateScreenState extends State<AddEstateScreen> {
  ...
  final TextEditingController _additionalNumberController =
      TextEditingController();
  ...
  final TextEditingController _advertisementTypeController =
      TextEditingController();
  ...
  final TextEditingController _arPathController = TextEditingController();

  final TextEditingController _propertyFaceController = TextEditingController();

  final TextEditingController _licenseNumberController =
      TextEditingController();
  final TextEditingController _advertiserNumberController =
      TextEditingController();
  final TextEditingController _advertiserTypeController =
      TextEditingController();
  ...
  Future<void> loadLocationDataFromCache() async {
    ...
    if (jsonString != null) {
      ...
      _additionalNumberController.text =
          location['additionalNumber']?.toString() ?? '';
      _longitudeController.text = location['longitude']?.toString() ?? '';
      _latitudeController.text = location['latitude']?.toString() ?? '';

      _addressController.text =
          ' ${location['region'] ?? ''}   مدينة  ${location['city'] ?? ''}  حي  ${location['district'] ?? ''} ${location['street'] ?? ''}';
    }
  }
...
// تحميل بيانات data2 من الكاش
    ...
    _authorizedController.text =
        data['brokerageAndMarketingLicenseNumber'] ?? '';
                                                              ...
                                                              children: [
                                                                      ...
                                                                      itemBuilder: (context, index) {
                                                                        return InkWell(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Card(
                                                                              color: _selectedRoomIndex == index ? Theme.of(context).primaryColor : Colors.grey,
                                                                              child: Container(
                                                                                child: Center(
                                                                                    child: Text(
                                                                                  _roomList[index] == 10 ? "9+" : _roomList[index].toString(),
                                                                ...
                                                                SizedBox(
                                                                  ...
                                                                  child: ListView.builder(
                                                                      scrollDirection: Axis.horizontal,
                                                                      // ignore: missing_return
                                                                      itemCount: _bathroomsList.length,
                                                                      itemBuilder: (context, index) {
                                                                        return InkWell(
                                                                          onTap:
                                                                              () {
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Card(
                                                                              color: _selectedBathroomsIndex == index ? Theme.of(context).primaryColor : Colors.grey,
                                                                              child: Container(
                                                                                child: Center(
                                                                                    child: Text(
                                                                                  _bathroomsList[index] == 10 ? "9+" : _bathroomsList[index].toString(),
                                                                                  style: TextStyle(color: Colors.white, fontSize: 20.0),
                                                                                )),
                                                                              ),
                                                                            ),
                                                                      ...
                                                                      itemBuilder: (context, index) {
                                                                        return InkWell(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Card(
                                                                              color: _selectedLounge == index ? Theme.of(context).primaryColor : Colors.grey,
                                                                              child: Container(
                                                                                child: Center(
                                                                                    child: Text(
                                                                                  _loungeList[index] == 10 ? "9+" : _loungeList[index].toString(),
                                                                                  style: TextStyle(color: Colors.white, fontSize: 20.0),
                                                                                )),
                                                                              ),
                                                                            ),
                                                                      ...
                                                                      itemBuilder: (context, index) {
                                                                        return InkWell(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Card(
                                                                              color: _selectedkitchen == index ? Theme.of(context).primaryColor : Colors.grey,
                                                                              child: Container(
                                                                                child: Center(
                                                                                    child: Text(
                                                                                  _kitchenList[index] == 10 ? "9+" : _kitchenList[index].toString(),
                                                                                  style: TextStyle(color: Colors.white, fontSize: 20.0),
                                                                                )),
                                                                              ),
                                                                            ),
                                                                                      ...
                                                                                      itemBuilder: (context, index) {
                                                                                        return InkWell(
                                                                                          ...
                                                                                          child: Container(
                                                                                            ...
                                                                                            decoration: BoxDecoration(
                                                                                              color: categoryController.interestSelectedList![index] ? Theme.of(context).primaryColor : Theme.of(context).cardColor,
                                                                                              ...
                                                                                              children: [
                                                                                                ...
                                                                                                Flexible(
                                                                                                  ...
                                                                                                  style: robotoMedium.copyWith(
                                                                                                    ...
                                                                                                    color: categoryController.interestSelectedList![index] ? Theme.of(context).cardColor : Theme.of(context).textTheme.bodyLarge!.color,
                                                                                                  ),
                                                                                                  maxLines: 2,
                                                                ...
                                                                Column(
                                                                  mainAxisAlignment:
                                                                      MainAxisAlignment
                                                                          .start,
                                                                  children: [
                                                                    categoryController.advanList!.length !=
                                                                            null
                                                                        ? Column(
                                                                            children: [
                                                                              ExpansionTile(
                                                                                        ...
                                                                                        itemBuilder: (context, index) {
                                                                                          return InkWell(
                                                                                            ...
                                                                                            child: Container(
                                                                                              ...
                                                                                              decoration: BoxDecoration(
                                                                                                color: categoryController.advanSelectedList![index] ? Theme.of(context).primaryColor : Theme.of(context).cardColor,
                                                                                                borderRadius: BorderRadius.circular(Dimensions.RADIUS_SMALL),
                                                                                                boxShadow: [
                                                                                                  BoxShadow(color: Colors.grey[Get.isDarkMode ? 800 : 200]!, blurRadius: 5, spreadRadius: 1)
                                                                                                ],
                                                                                                ...
                                                                                                children: [
                                                                                                  Flexible(
                                                                                                    ...
                                                                                                    style: robotoMedium.copyWith(
                                                                                                      ...
                                                                                                      color: categoryController.advanSelectedList![index] ? Theme.of(context).cardColor : Theme.of(context).textTheme.bodyLarge!.color,
                                                                                                    ),
                                                                                                    maxLines: 2,
                                                                                                    overflow: TextOverflow.ellipsis,
                                                                                                  )),
                                                      ...
                                                      child: SizedBox(
                                                          ...
                                                          child: Column(
                                                              ...
                                                              children: [
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              height: 41,
                                                                              decoration: BoxDecoration(
                                                                                  color: _djectivePresenter == 0 ? Theme.of(context).secondaryHeaderColor : Colors.transparent,
                                                                                  border: Border.all(
                                                                                    width: 1,
                                                                              ...
                                                                              child: Center(
                                                                                  child: Text(
                                                                                'authorized'.tr,
                                                                                style: robotoBlack.copyWith(fontSize: 16, color: _djectivePresenter == 0 ? Colors.white : Colors.blue),
                                                                              )),
                                                                            ),
                                                                          ),
                                                                        ),
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Container(
                                                                              decoration: BoxDecoration(
                                                                                  color: _djectivePresenter == 1 ? Theme.of(context).secondaryHeaderColor : Colors.transparent,
                                                                                  border: Border.all(
                                                                                    width: 1,
                                                                                    color: Colors.blue[500]!,
                                                                                  ),
                                                                              ...
                                                                              child: Center(
                                                                                  child: Text(
                                                                                'owner'.tr,
                                                                                style: robotoBlack.copyWith(fontSize: 16, color: _djectivePresenter == 1 ? Colors.white : Colors.blue),
                                                                              )),
                                                                            ),
                                                                          ),
                                                                        ),
                                                                ...
                                                                MyTextField(
                                                                  hintText:
                                                                      'enter_the_document_number'
                                                                          .tr,
                                                                  controller:
                                                                      _deedNumberController,
                                                                  focusNode:
                                                                      _documentNumberFocus,
                                                                  inputType:
                                                                      TextInputType
                                                                          .number,
                                                                  size: 17,
                                                                ...
                                                                MyTextField(
                                                                  hintText:
                                                                      'enter_the_advertisement_number'
                                                                          .tr,
                                                                  controller:
                                                                      _addNumberController,
                                                                  inputType:
                                                                      TextInputType
                                                                          .number,
                                                                  size: 17,
                                                                ...
                                                                child: Column(
                                                                    children: [
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                            DataView(
                                                                          title: _propertyTypeController.text.toString() != "ارض"
                                                                              ? 'price'.tr
                                                                              : "سعر المتر",
                                                                          value: _priceController
                                                                              .text
                                                                              .toString(),
                                                                        ),
                                                                      ),
                                                                      ...
                                                                      SizedBox(
                                                                          height:
                                                                              Dimensions.PADDING_SIZE_SMALL),
                                                                      _propertyTypeController.text.toString() ==
                                                                              "ارض"
                                                                          ? Padding(
                                                                              padding: const EdgeInsets.only(right: 10, left: 10),
                                                                              child: DataView(
                                                                                title: 'اجمالي سعر الارض'.tr,
                                                                                value: _totalPriceController.text.toString(),
                                                                              ),
                                                                            )
                                                                          : Container(),
                                                                      SizedBox(
                                                                          ...
                                                                          ? Column(
                                                                              children: [
                                                                                Padding(
                                                                                  padding: const EdgeInsets.only(right: 10, left: 10),
                                                                                  child: DataView(
                                                                                    title: 'number_rooms'.tr,
                                                                                    value: _selectedRoomIndex.toString(),
                                                                                  ),
                                                                                ),
                                                                                ...
                                                                                Padding(
                                                                                  padding: const EdgeInsets.only(right: 10, left: 10),
                                                                                  child: DataView(
                                                                                    title: 'number_toilets'.tr,
                                                                                    value: _selectedBathroomsIndex.toString(),
                                                                                  ),
                                                                                ),
                                                                                SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                                                                                network_type != null
                                  ...
                                  child: !restController.isLoading
                                      ? CustomButton(
                                          onPressed: () {
                                            ...
                                            String authorized;
                                            String adNumber;
                                            authorized = _authorizedController
                                                .text
                                                .trim();
                                            price =
                                                _priceController.text.trim();
                                            shortDesc = _shortDescController
                                                .text
                                                .trim();
                                            space =
                                            ...
                                            String property =
                                                '[{"name":"حمام", "number":"$_selectedBathroomsIndex"},{"name":"غرف نوم", "number":"$_selectedRoomIndex"},{"name":"صالات", "number":"$_selectedLounge"},{"name":"مطبخ", "number":"$_selectedkitchen"}]';
                                            ...
                                            if (currentStep == 1) {
                                              ...
                                              if (_djectivePresenter == 0 &&
                                                  authorized.isEmpty) {
                                                showCustomSnackBar(
                                                    'ادخل رقم التفويض');
                                              } else if (adNumber.isEmpty) {
                                                showCustomSnackBar(
                                                    'ادخل رقم الإعلان'.tr);
                                              } else {
                                              ...
                                              setState(() {
                                                for (final item
                                                    in _selectedInterfaceistItems) {
                                                  interface.add({
                                                    '"' "name" '"': '"$item"',
                                                    '"' "space" '"': item ==
                                                            "الواجهة الشمالية"
                                                        ? '"${_northController.text.toString()}"'
                                                        : item ==
                                                                "الواجهة الشرقية"
                                                            ? '"${_eastController.text.toString()}"'
                                                            : item ==
                                                                    "الواجهة الغربية"
                                                                ? '"${_westController.text.toString()}"'
                                                                : item ==
                                                                        "الواجهة الجنوبية"
                                                                    ? '"${_southController.text.toString()}"'
                                                                    : ""
                                                  });
                                                }
                                              });
                                              ...
                                              restController.addEstate(EstateBody(
                                                ...
                                                // categoryId:"1",
                                                ageEstate:
                                                    _propertyAgeController.text
                                                        .toString(),
                                                arPath: _arPathController.text,
                                                districts: _districtController
                                                    .text
                                                    .toString(),
                                                floors: "4545",
                                                ...
                                                postalCode:
                                                    _postalCodeController.text
                                                        .toString(),
                                                planNumber:
                                                    _planNumberController.text
                                                        .toString(),
                                                northLimit: _northController
                                                    .text
                                                    .toString(),
                                                eastLimit: _eastController.text
                                                    .toString(),
                                                westLimit: _westController.text
                                                    .toString(),
                                                southLimit: _southController
                                                    .text
                                                    .toString(),
                                                licenseNumber:
                                          ...
                                          buttonText: currentStep == stepLength
                                              ? 'confirm'.tr
                                              : 'next'.tr,
                                        )
                                      : Center(
