...
import 'package:abaad_flutter/controller/wallet_controller.dart';
import 'package:abaad_flutter/helper/price_converter.dart';
...
import 'package:abaad_flutter/view/base/title_widget.dart';
import 'package:abaad_flutter/view/screen/wallet/widget/history_item.dart';
                                ...
                                child:  Row(mainAxisAlignment: widget.fromWallet ? MainAxisAlignment.start : MainAxisAlignment.center, children: [
                                  ...
                                  widget.fromWallet ? Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min,
                                    children: [
                                      ...
                                      Text(
                                        PriceConverter.convertPrice(userController.userInfoModel?.walletBalance ?? 0),
                                ...
                                child: InkWell(
                                  onTap: (){
                                    ResponsiveHelper.isMobile(context) ? Get.bottomSheet(
                                        WalletBottomSheet(fromWallet: widget.fromWallet, key: Key("") )
                                    ) : Get.dialog(
                                      Dialog(child: WalletBottomSheet(fromWallet: widget.fromWallet, key: Key("") )),
                                    );
                                  },
                                  child: Row(
                                    children: [
                          ...
                          Column(children: [
                            ...
                            walletController.transactionList != null ? walletController.transactionList!.isNotEmpty ? GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return HistoryItem(index: index,fromWallet: widget.fromWallet, data: walletController.transactionList!, key: Key(""), );
                              },
