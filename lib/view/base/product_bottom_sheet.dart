          ...
          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.end, children: [
            ...
            Padding(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: productController.addOnActiveList[index] ? Theme.of(context).primaryColor : Theme.of(context).colorScheme.surface,
                            borderRadius: BorderRadius.circular(Dimensions.RADIUS_SMALL),
                ...
                isAvailable ? SizedBox() : Container(
                  alignment: Alignment.center,
                ...
                (!widget.product.scheduleOrder && !isAvailable) ? SizedBox() : Row(children: [
                  ElevatedButton(
